...
If no approved adapter exists, invoke the repository discovery specialist and produce a complete repository adapter proposal. Do not modify product code. End with blockers and the first explicit approval request.

...
### Primary navigation
- **A. Bottom tab bar (3–4 tabs)** — iOS-native; thumb-reachable; always visible. *(Recommended.)*
...
### Workspace switcher
- **S1. Top-left avatar in the header** (iOS Mail pattern) → sheet. *(Recommended for v1.)*
...
- **M1. Bottom sheet on "New conversation" tap** — 6 large radio-style rows. *(Only viable at 6 modes.)*
...
### Search affordance
- **Q1. Dedicated tab** in the bottom bar (4th tab). *(Recommended if 4 tabs is acceptable.)*
- **Q2. Slide-down search bar** in the header of every page (iOS Spotlight pattern).
- **Q3. Magnifier icon in the header** → opens a sheet. *(Recommended if bottom tab is constrained to 3.)*
